...
settings.FILENAME = f'participant_{participant_id}'
...
# -------------------------
# Stimuli file names and location for Tasks A and B and correct answers
# -------------------------
...
task_a_stimuli = [
    os.path.join(STIMULI_DIR, f) for f in [
        'aurajoki2a.png', 'paimionjoki1a.png', 'porvoonjoki3a.png', 'vantaanjoki4a.png',
        'aurajoki3a.png', 'porvoonjoki2a.png', 'paimionjoki4a.png', 'vantaanjoki1a.png'
    ]
]

task_b_stimuli = [
    os.path.join(STIMULI_DIR, f) for f in [
        'porvoonjoki1b.png', 'aurajoki4b.png', 'paimionjoki3b.png', 'vantaanjoki2b.png',
        'aurajoki1b.png', 'vantaanjoki3b.png', 'paimionjoki2b.png', 'porvoonjoki4b.png'
    ]
]

# Predefined correct answers
correct_answers = {
    'aurajoki2a.png': 'C', 'porvoonjoki1b.png': 'A', 'paimionjoki1a.png': 'A', 
    'aurajoki4b.png': 'C', 'porvoonjoki3a.png': 'B', 'paimionjoki3b.png': 'A', 
    'vantaanjoki4a.png': 'C', 'vantaanjoki2b.png': 'B', 'aurajoki3a.png': 'B', 
    'aurajoki1b.png': 'C', 'porvoonjoki2a.png': 'A', 'vantaanjoki3b.png': 'B', 
    'paimionjoki4a.png': 'C', 'paimionjoki2b.png': 'A', 'vantaanjoki1a.png': 'B', 
    'porvoonjoki4b.png': 'C'
}
...
experiment_end = (
    ...
    "You can leave the screen as it is and let the experimenter know you're done.\n\n"
    "Thank you for participating!\n\n"
)

# -------------------------
# Calibration and Instructions
# -------------------------
...
# Present fixation point before starting Task A
...
for stim in task_a_stimuli_images:
    ...
    stimulus_duration = show_fixed_stimulus(win, stim, tracker, stimulus_duration=60, monitor_refresh_rate=monitor_refresh_rate, cooldown_time=2)
...
# -------------------------
csv_filename = os.path.join(data_dir, f'participant_{participant_id}.csv')
csv_data = trial_log + [{
...
if dummy_mode:
    ...
    h5_filename = os.path.join(data_dir, f'participant_{participant_id}.h5')
